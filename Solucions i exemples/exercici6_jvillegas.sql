    ...
    BEGIN
      ...
      LOOP
        FETCH CUR_EMP INTO REG_ID, REG_NAME;
          ...
          RETURN DBMS_OUTPUT.PUT_LINE(' ');
          RETURN DBMS_OUTPUT.PUT_LINE('ID: ' || REG_ID || '  ----  Nombre trabajador: ' || REG_NAME);
          RETURN DBMS_OUTPUT.PUT_LINE('Porcentaje de clientes respecto del total: ' || PERC_EMP || '%');
